...
- **Enoturismo (B2C)**: esperienze, slot/calendario, prenotazioni, codici sconto, recensioni, newsletter, operatori, CRM visitatori (con tracciamento e-commerce/negozio fisico)
- **Commerciale (B2B)**: agenti (con provincie di competenza, credenziali proprie, sconto standard cliente), clienti (anagrafica italiana completa: P.IVA, PEC, SDI, IBAN...), listini, ordini, import Excel, News e Catalogo (contenuti creati qui, visibili nel portale agenti)
