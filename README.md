...
- **Magazzino**: Kanban ordini (drag&drop tra Nuovo/In lavorazione/Sospeso/Evaso, sincronizzato con Commerciale), nota magazziniere per ordine (visibile a Commerciale e all'agente), prodotti finiti/materie prime con soglie e alert email, registro dei movimenti valorizzato a costo medio ponderato (carichi, scarichi, degustazioni, inventari, foglio dei costi, controlli notturni)
