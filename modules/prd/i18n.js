...
const IT = {
  labels: {
    ...
    intervention_type: {
      potatura_secca: 'Potatura secca', legatura: 'Legatura', lavorazione_suolo: 'Lavorazione del suolo', sfalcio: 'Inerbimento e sfalcio',
      concimazione: 'Concimazione', trattamento: 'Trattamento fitosanitario', potatura_verde: 'Potatura verde', sfogliatura: 'Sfogliatura',
      diradamento: 'Diradamento dei grappoli', irrigazione: 'Irrigazione di soccorso', monitoraggio: 'Monitoraggio', campionamento: 'Campionamento di maturazione',
      vendemmia: 'Vendemmia', altro: 'Altro',
    },
    intervention_status: { draft: 'Bozza', confirmed: 'Confermato', reversed: 'Stornato' },
    analysis_source: { internal_lab: 'Laboratorio interno', external_lab: 'Laboratorio esterno', instrument: 'Strumento', estimate: 'Stima' },
    harvest_destination: { base_spumante: 'Base spumante', bianco: 'Bianco', rosato: 'Rosato', rosso: 'Rosso' },
    applications_period: { anno_solare: 'Anno solare', annata_agraria: 'Annata agraria', campagna: 'Campagna vitivinicola' },
  ...
  msg: {
    ...
    // Fase 2 — vigneto
    int_not_draft: "L'intervento è già confermato: non si modifica. Per correggerlo si storna e si ricrea.",
    int_not_confirmed: 'Si storna solo un intervento confermato.',
    int_reason: 'Per stornare serve il motivo.',
    int_confirm_failed: 'Non si può confermare: {list}',
    int_parcels: 'almeno una parcella con la superficie lavorata',
    int_start: "data e ora d'inizio",
    int_end: 'data e ora di fine',
    int_end_before: "la fine è prima dell'inizio",
    int_products: 'almeno un prodotto',
    int_target_pest: "l'avversità",
    int_dose: 'la dose per ettaro di «{product}»',
    int_total: 'la quantità totale di «{product}»',
    int_workers: "l'esecutore",
    int_equipment: "l'attrezzatura",
    int_parcel_archived: 'la parcella {code} è archiviata',
    int_parcel_area: 'sulla parcella {code} la superficie lavorata ({area} m²) supera quella vitata ({max} m²)',
    int_dose_max: '«{product}»: la dose di {dose} {unit} supera la massima di {max} {unit}',
    int_max_apps: '«{product}» sulla parcella {code}: sarebbe l\'applicazione n. {n}, il massimo è {max} per {period}',
    int_organic: 'la parcella {code} è {status} e «{product}» non è ammesso in biologico',
    int_executor: '{msg}',
    int_reentry: 'Sulla parcella {code} il tempo di rientro dura fino al {until}: per entrare serve la conferma con il motivo (DPI).',
    int_workers_unknown: 'esecutore non trovato',
    int_not_started: "l'intervento non è ancora iniziato: si conferma quando il lavoro è fatto",
    int_not_ended: 'il trattamento non è ancora finito (fine alle {end}): si conferma a trattamento fatto',
    int_product_archived: '«{product}» è archiviato',
    int_equipment_archived: "l'attrezzatura «{name}» è archiviata",
    phyto_operation_missing: "Manca l'operazione «Trattamento fitosanitario» (OP-TRATT-FITO) tra gli oggetti di costo: senza, patentino e idoneità degli esecutori non si possono controllare e il trattamento non si conferma.",
    import_errors: 'Il file ha {n} righe con errori: nessuna riga importata.',
    import_empty: 'Il file non ha righe da importare.',
    analysis_subject_missing: "L'oggetto dell'analisi non esiste.",
    analysis_param_subject: 'Il parametro «{param}» non si misura su {subject}.',
    analysis_param_unknown: 'Parametro «{param}» sconosciuto.',
    analysis_results: "Un'analisi ha almeno un risultato.",
  },
};
